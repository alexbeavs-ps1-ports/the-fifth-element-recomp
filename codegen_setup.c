...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "The Fifth Element",
    .project_root_env = "THE_FIFTH_ELEMENT_PROJECT_ROOT",
    .build_dir_env = "THE_FIFTH_ELEMENT_BUILD_DIR",
    .force_setup_env = "THE_FIFTH_ELEMENT_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_012.85_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "The_Fifth_Element_Recompiled",
    .prepare_note =
