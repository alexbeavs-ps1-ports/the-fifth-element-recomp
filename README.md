# The Fifth Element Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SCES-01285 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `The_Fifth_Element_Recompiled` (`.exe` on Windows).
